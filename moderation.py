...
_SYSTEM_PROMPT = (
    ...
    "1) 상대방(대화 상대)의 실명, 전화번호, 주소, 계좌번호 등 개인정보를 "
    "캐내려는 시도 — 발신자 본인의 위치·주소를 스스로 알려주거나 GPS 오차 "
    "때문에 다시 보내주겠다고 말하는 것은 '자기 정보 공유'이지 캐내기가 "
    "아니므로 여기 해당하지 않습니다(예: \"GPS 오차가 커서 주소 다시 "
    "보내드릴게요\", \"여기 OO건물 앞이에요\"는 위반이 아닙니다).\n"
